...
const Chatbot = () => {
  ...
  const handleSend = async () => {
    ...
    // Define botResponse outside of the setTimeout so it can be accessed later
    let botResponse = "Sorry, I don't have knowledge about that. Please ask about tech products like phones, laptops, tablets, desktops, speakers, microphones, or anything else techy you may want to know about.";
    ...
    setTimeout(() => {
      ...
      // Now that botResponse is set, we can safely speak it
      speakText(botResponse);
    }, 1000);
  };
